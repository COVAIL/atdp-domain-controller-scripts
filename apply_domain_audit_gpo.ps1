...
Import-Module -Name (Join-Path $PSScriptRoot event_forwarding_module_functions.psm1 -Resolve) -Force -WarningAction SilentlyContinue
Configure-DomainControllerAuditGroupPolicy
